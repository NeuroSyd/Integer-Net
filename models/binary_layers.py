'''
Clone binary_layers.py file from https://github.com/DingKe/nn_playground/tree/master/xnornet
'''
...
from models.binary_ops import binarize
...
class BinaryDense(Dense):
    ...
    def build(self, input_shape):
        ...
        print ('DEBUG:------ self.kernel_lr_multiplier', self.kernel_lr_multiplier)
...
class BinaryConv2D(Conv2D):
    ...
    def build(self, input_shape):
        ...
        if self.kernel_lr_multiplier == 'Glorot':
            ...
            print (self.kernel_lr_multiplier)
            #print('Glorot learning rate multiplier: {}'.format(self.lr_multiplier))

        print ('DEBUG:------ CONV self.kernel_lr_multiplier', self.kernel_lr_multiplier)
        self.kernel_constraint = Clip(-self.H, self.H)
        self.kernel_initializer = initializers.RandomUniform(-self.H, self.H)
